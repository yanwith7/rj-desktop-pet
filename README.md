...
- 单击身体：和窝头RJ打个招呼吧～
- 点击头部：摸摸头，会害羞哦～，它很喜欢你，并恢复了 10 点活力
- 右键：打开动作菜单
- 拖动：可自由移动宠物位置
- 大小滑杆：72–300 px 自由缩放，默认是更接近 Codex 桌宠的小尺寸
- 向左／向右走：播放对应动作并移动窗口
- 转圈：持续旋转，直到切换其他状态；眼睛变成眩晕的 `𖦹 𖦹`
- 文字气泡：默认“主人，今天也请加油吧！”，双击可编辑文字，留下一句鼓励或者是作为todolist
...
- 可选粉色血条：每 3 分钟自然减少 1 点；每次菜单动作扣除 2 点、左右走扣除 2 点、“呀吼”扣除 3 点；摸头恢复 10 点
- 记住上次窗口位置
